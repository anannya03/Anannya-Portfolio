  ...
  const content = (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full max-w-2xl h-fit rounded-lg overflow-hidden bg-projectModal shadow-lg cursor-auto"
      >
        <img
          className="w-full"
          src={imgSrc}
        ...
        <div className="p-8">
          ...
          <div>
            <p className="font-bold mb-2 text-xl">
              Project Links<span className="text-amber">.</span>
            </p>
            <div className="flex items-center gap-4 text-sm">
              <Link
                target="_blank"
                rel="nofollow"
                className="text-zinc-300 hover:text-amber transition-colors flex items-center gap-1"
                href={code}
              >
